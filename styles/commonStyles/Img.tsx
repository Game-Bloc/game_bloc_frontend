...
export const Img = styled(StyledImg)`
  ...
  border-width: ${(props) => (props.borderWidth ? `${props.borderWidth}` : "unset")};
  border-color: ${(props) => (props.borderColor ? `${props.borderColor}` : "unset")};
  border-style: ${(props) => (props.borderStyle ? `${props.borderStyle}` : "unset")};
